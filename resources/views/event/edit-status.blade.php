...
<div class="page-content-wrapper">
	...
	<div class="portlet-body form" style="height: auto;">
		<form action="{{route('event.edits', ['id' => $model->id])}}" method="post" enctype="multipart/form-data">
			@csrf
			<div class="form-body">
				<div class="form-group form-md-line-input has-success form-md-floating ">
					<div class="input-icon right">
						<label for="form_control_1">Trạng thái mã giảm giá</label>
						<select name="status" class="form-control">
							<option value="1">Duyệt mã</option>
						</select>
					</div>
				</div>
			</div>
