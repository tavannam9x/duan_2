...
<body>
    ...
    <div class="main-content-blog">
                                        ...
                                        <form action="{{route('cart.add')}}" method="post" class="form-pay">
                                           @csrf
                                            ...
                                            @if(Illuminate\Support\Facades\Auth::check())
                                                ...
                                                <input type="text" class="form-control" value="{{ Illuminate\Support\Facades\Auth::user()->name }}" id="exampleInputEmail1" name="name" aria-describedby="emailHelp">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{old('name')}}" id="exampleInputEmail1" name="name" aria-describedby="emailHelp" placeholder="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="order_address" class="form-control" value="{{old('order_address')}}" id="exampleInputEmail1" aria-describedby="emailHelp">
        ...
        @else
            <div class="container">
                <h1 style="color: black">DEO CO SAN PHAM TRONG GIO HANG</h1>
            </div>
        @endif
    </div>
